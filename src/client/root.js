...
class Root extends React.Component {
	...
	componentDidMount() {
		const { history, isMobile, setCurrentUrl, requestConfig } = this.props;
		...
		if (typeof window != "undefined") {
			this.breakpointChange = window.addEventListener(
				"resize",
				debounce(this.setBreakpoints, 100),
				false
			);
