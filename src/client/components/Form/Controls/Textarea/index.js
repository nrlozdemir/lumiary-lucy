...
const Textarea = (props) => {
	const {
		className, counterClass, filledClass, id, input, label, maxLength, placeholder, rows,
	...
	return (
      ...
      <textarea id={ id } { ...input } className={ cx(style.textarea, { [filledClass]: dirty }) } placeholder={ placeholder } rows={ rows } />
      { touched &&
        (
