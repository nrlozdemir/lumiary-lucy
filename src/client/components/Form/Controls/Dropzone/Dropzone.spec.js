...
const mockFileData = {
	...
	fileUrl:"https://s3.amazonaws.com/quickframe-media-dev/1b536ead-6133-4493-a422-27203e764f79_download.jpeg",
	signedUrl:"https://s3.amazonaws.com/quickframe-media-dev%2Fuploads/1b536ead-6133-4493-a422-27203e764f79_download.jpeg?AWSAccessKeyId=AKIAIILRAYHRCIOFIR4Q&Content-Type=image%2Fjpeg&Expires=1535733330&Signature=pgIOHuuJYiPTa55uYmnp9UxM6Gw%3D&x-amz-acl=private",
...
describe('Dropzone Component', () => {
	...
	describe('Functionality',() => {
		it('calls handleConfirmUpload on upload when dialog is null', () => {
			...
			wrapper.find('Dropzone').instance().handleUpload(mockFileData)
		...
		it('calls handleCancelUpload on exiting dialog', () => {
			...
			dialogWrapper.find('Dialog').props().confirmProps.handleConfirm()
