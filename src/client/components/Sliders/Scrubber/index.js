  ...
  return (
    ...
    >
      <path
        fill="#505050"
        fillRule="evenodd"
        d="M7.863 10L0 4.993 7.843 0l1.12.713-6.005 3.824.004-.003-.721.46L9 9.296 7.863 10z"
      />
    </svg>
  )
}
  ...
  return (
    ...
    >
      <path
        fill="#505050"
        fillRule="evenodd"
        d="M1.137 10L9 4.993 1.157 0 .037.713l6.005 3.824-.004-.003.721.46L0 9.296 1.137 10z"
      />
    </svg>
  )
}
      ...
      <React.Fragment>
        {horizontal ? (
          <Scrollbars
            ...
            renderTrackVertical={(props) => (
              <div {...props} className={styles.emptyScrollBar} />
            )}
            renderThumbVertical={(props) => (
              <div {...props} className={styles.emptyScrollBar} />
            )}
          ...
          <div className={styles.ticksWrapper}>
            <div className={styles.ticks}>
              {Object.keys(marks).map((m, i) => (
                <p
                  key={`mark-${i}`}
                  onClick={() => this.markClick(i, totalWidth)}
