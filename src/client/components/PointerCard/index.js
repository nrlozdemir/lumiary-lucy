    ...
    <div className={style.radialChart}>
      ...
      <div className={style.pointerContainer}>
        <div className={style.pointerWrapper}>
          <span className="font-secondary-second font-size-12 color-cool-grey">
            Avg
          </span>
          <div className={style.pointerImages}>
            ...
            <div
              ...
              style={{ transform: `rotate(${data.pointerData || 0}deg)` }}
            >
              <div className={style.pointer} />
            </div>
          </div>
          <span className="float-left font-secondary-second font-size-12 color-cool-grey">
            Worse
          </span>
          <span className="float-right font-secondary-second font-size-12 color-cool-grey">
            Better
          </span>
      ...
      >
        <p className={style.infoText}>
          ...
          <span className={style.textBold}>{52}%</span> of your library is shot
          in <span className={style.textBold}>24fps</span>
        </p>
      </div>
    </div>
  )
