  ...
  onScrollChange(val) {
	...
	render() {
        ...
        <div className={cn(style.thumbnailContainer, 'mt-32')}>
          ...
          >
            {this.props.slideImages.map((image, i) => (
              <div className={cn(style.thumbnail,{ [style['activeThumb']]: i === this.state.slideIndex })} key={`thumbnailImage-${i}`}>
        ...
        <div className="mt-16">
          <ScrollSlider
            ...
            marks={this.props.slideImages.reduce((prevData,currenData, currentIndex) => {
