...
export default class LeftArrowCircleFlatIconComponent extends React.Component {
	...
	render() {
		...
		return (
			<span {...this.props} className={classnames("icon-Left-Arrow-Circle", this.props.className)}>
