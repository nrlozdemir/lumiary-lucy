...
export const email = (value) =>
  value && validateEmail(value) ? undefined : 'Invalid email address!'
export const number = (value) =>
  isNaN(Number(value)) ? 'Must be a number!' : undefined
export const validUrl = (value) =>
  value && validateURL(value) ? undefined : 'Invalid url format!'
export const name = (value) =>
  value && validName(value)
    ? undefined
    : 'Invalid format (Letters, numbers, dashes, and underscores only)!'
