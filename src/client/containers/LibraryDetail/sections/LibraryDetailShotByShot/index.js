...
//                                 const imgUrl = `${mediaUrl}/lumiere/${this.props.authProfile.brand.uuid}/${this.props.selectedVideo}/${this.state.selectedImage}/`
//                                 return !gender ||
//                                   !uuid ||
...
//                                 const imgUrl = `${mediaUrl}/lumiere/${this.props.authProfile.brand.uuid}/${this.props.selectedVideo}/${this.state.selectedImage}/${shotInfoData.shot.frames[i]}`
