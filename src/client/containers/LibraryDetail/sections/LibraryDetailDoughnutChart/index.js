					...
					{(!!selectedCard || selectedCard === 0) ? (
							...
							<div className={style.doughnutPanelTab}>
								...
								<div className={style.dataWrapper}>
									<div className={style.panelChart}>
										...
										<div className={style.doughnutChartContainer}>
											<DoughnutChart doughnutData={selectedCardData.libraryData} />
											<p className="pt-32">
                        ...
                        <span className={style.textBold}> {selectedCardData.libraryFpsData.fps}fps</span>
									...
									<div className={style.panelChart}>
										...
										<div className={style.doughnutChartContainer}>
											<DoughnutChart doughnutData={selectedCardData.industryData} color="#8567f0" />
                        ...
                        <span className={style.textBold}> {selectedCardData.industryFpsData.fps}fps</span>
								...
								<div className="w-100 mt-48 mb-48">
									{selectedCardData && <LineChart
										backgroundColor="#242b49"
										dataSet={() => this.combineChartData(selectedCardData.lineChartData)}
										width={1070}
										height={291}
